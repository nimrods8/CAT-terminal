...
#define SIGNATURE_OF_BITMAP 0x4D42
...
typedef struct _avifieldindex_chunk {
    ...
    //int64_t qwBaseOffset; // offsets in aIndex array are relative to this
    DWORD qwBaseOffsetL; // offsets in aIndex array are relative to this
    DWORD qwBaseOffsetH; // offsets in aIndex array are relative to this
...
//! this is part o the AVIFIELDINDEX structure
//  which is read from avi file after the
//  header
typedef struct avifieldindex_entry {
    DWORD dwOffset;
    DWORD dwSize; // size of all fields
    // (bit 31 set for NON-keyframes)
    DWORD dwOffsetField2; // offset to second field
